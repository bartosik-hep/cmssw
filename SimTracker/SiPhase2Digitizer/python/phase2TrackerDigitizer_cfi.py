...
PixelDigitizerAlgorithmCommon = cms.PSet(
    ...
    WaveFormModel = cms.PSet(
       Krummenacher = cms.double(60.),
       KrummSatCharge = cms.double(2000.),
       KrummChargeOffset = cms.double(0.),       # must be less than the threshold
       riseTimeSignal = cms.double(10.),
       riseTimeOffset = cms.double(10000),
       riseTimeSlope = cms.double(0.00001),
       TimeOffset = cms.double(0.),
       GroundOffset = cms.double(0.),
       SignalOffset = cms.double(0.),
       AddKrummSmearing = cms.bool(False),
       KrummSmearing = cms.double(10.0),         # Given in percentage
       phase = cms.double(0.),
